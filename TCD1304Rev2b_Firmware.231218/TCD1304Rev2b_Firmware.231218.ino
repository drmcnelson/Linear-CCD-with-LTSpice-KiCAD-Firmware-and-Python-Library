...
const char authorstr[] =  "(c) 2023 by Mitchell C. Nelson, Ph.D. ";
...
const int fMPinMonitor = 5;     // Clock monitor  (connect this to pin 4)
...
void help() {
  ...
  Serial.println("#  store <identifier>");
  ...
  Serial.println("#");
  Serial.println("#Microcontroller temperature");
   ...
   */
    ...
    */
     ...
     */
	 ...
	 Serial.print( "Error: upload with value out of range." );
       }
     }
