...
Okay, with the above, I hope that I have convinced you that this not just a nifty little sensor device, but that it is actually a professional grade instrument and that you can do good science with it.  For more good news, it turns out that it is not very expensive.  Since this repositories provides the design files, firmware and software, you can build one for yourself, or if you like you can contact me for an assembled board.  Finally, though I feel this is a good alternative to a lot of very expensive instruments, it is intentionally not the design you would use for for manufacturing at scale. If that is what you are after, please contact me before spinning.
